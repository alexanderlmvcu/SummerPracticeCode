...
class PotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create potion" do
    assert_difference('Potion.count') do
      post potions_url, params: { potion: { name: @potion.name, price: @potion.price, year: @potion.year } }
    end
  ...
  test "should update potion" do
    patch potion_url(@potion), params: { potion: { name: @potion.name, price: @potion.price, year: @potion.year } }
